...
public class Hard {
    ...
    int timeLeft = 180; // Time in seconds
    ...
    public Hard() {
        ...
        frame.setTitle("Minesweeper/Hard Category");
    ...
    public void startNewGame() {
        ...
        while (true) {
            String rowsInput = JOptionPane.showInputDialog(frame, "Enter number of rows (10 to 20):");
            String colsInput = JOptionPane.showInputDialog(frame, "Enter number of columns (10 to 20):");
            ...
            try {
                ...
                if (rows >= 10 && rows <= 20 && cols >= 10 && cols <= 20) {
                    ...
                    JOptionPane.showMessageDialog(frame, "Rows and columns must be between 10 and 20. Please try again.");
                }
