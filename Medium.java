...
public class Medium {
    ...
    int timeLeft = 300; // Time in seconds
    ...
    public Medium() {
        ...
        frame.setTitle("Minesweeper/Medium Category");
    ...
    public void startNewGame() {
        // Keep asking for valid rows and columns until valid input is provided
        while (true) {
            String rowsInput = JOptionPane.showInputDialog(frame, "Enter number of rows (10 to 15):");
            String colsInput = JOptionPane.showInputDialog(frame, "Enter number of columns (10 to 15):");
            ...
            try {
                ...
                if (rows >= 10 && rows <= 15 && cols >= 10 && cols <= 15) {
                    break; // Exit the loop if input is valid
                } else {
                    JOptionPane.showMessageDialog(frame, "Rows and columns must be between 10 and 15. Please try again.");
                }
        ...
        // Calculate the number of mines (e.g., 10% of the total number of tiles)
